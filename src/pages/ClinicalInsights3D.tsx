...
export default function ClinicalInsights3D() {
  return (
...
<span className="px-2 py-1 bg-primary/10 text-primary text-[10px] font-bold rounded-md">3D MODEL</span>
</div>
...
<div className="p-4 bg-slate-50 dark:bg-slate-800/50 flex justify-center gap-6">
...
<span className="text-[10px] font-medium text-slate-500">Elevated</span>
</div>
<div className="flex items-center gap-2">
<div className="size-2 rounded-full bg-primary"></div>
<span className="text-[10px] font-medium text-slate-500">Optimal</span>
</div>
</div>
</div>
</section>
