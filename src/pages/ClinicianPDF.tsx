...
export default function ClinicianPDF() {
  return (
...
<div className="sticky top-0 z-30 bg-white/80 dark:bg-background-dark/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 px-4 py-3 flex items-center justify-between no-print">
...
<div className="bg-white dark:bg-slate-900 print-container print-shadow rounded-xl overflow-hidden border border-slate-100 dark:border-slate-800">
{/* Header Section */}
<header className="p-8 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30">
...
<p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Patient ID: #GG-88291 • DOB: 05/12/1978</p>
...
<p className="text-slate-500 dark:text-slate-400 text-sm">Report Date: Oct 24, 2023</p>
<p className="text-slate-500 dark:text-slate-400 text-sm">Period: Last 30 Days</p>
</div>
</div>
</header>
{/* 1. Clinical Summary */}
...
<div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-6 border-l-4 border-primary">
...
<div className="h-48 w-full bg-slate-50 dark:bg-slate-800/40 rounded-lg p-4 flex items-end justify-between gap-1 relative overflow-hidden">
...
<div className="h-48 w-full bg-slate-50 dark:bg-slate-800/40 rounded-lg p-4 flex items-center justify-center relative">
...
<section className="p-8 border-t border-slate-100 dark:border-slate-800">
...
<div className="w-32 h-64 bg-slate-100 dark:bg-slate-800 rounded-[3rem] relative overflow-hidden border border-slate-200 dark:border-slate-700">
{/* Heel Pressure */}
...
{/* 4. Metric Table */}
<section className="p-8 bg-slate-50 dark:bg-slate-800/20">
<div className="flex items-center gap-2 mb-6">
...
<td className="px-6 py-4 text-sm">112 steps/min</td>
<td className="px-6 py-4 text-sm text-slate-400">100 - 120</td>
...
<td className="px-6 py-4 text-sm">8,432</td>
<td className="px-6 py-4 text-sm text-slate-400">7,000 - 10,000</td>
<td className="px-6 py-4">
<span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400 uppercase">Normal</span>
</td>
</tr>
...
<td className="px-6 py-4 text-sm">94.2 N/cm²</td>
<td className="px-6 py-4 text-sm text-slate-400">40 - 85</td>
<td className="px-6 py-4">
...
<td className="px-6 py-4 text-sm">0.74 m</td>
<td className="px-6 py-4 text-sm text-slate-400">0.70 - 0.82</td>
<td className="px-6 py-4">
<span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400 uppercase">Normal</span>
</td>
</tr>
...
<div className="fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-background-dark/95 backdrop-blur-xl border-t border-slate-200 dark:border-slate-800 px-6 py-3 flex justify-between items-center z-40 no-print">
